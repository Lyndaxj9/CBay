...
public class UserService {
	...
	/*
	 * Call this method whenever any user Registers OR login successfully For
	 * Successful Registration : User user = getUserInfo(InsertBuyer("name",
	 * "username", "pw" etc) For Successful Login : User user =
	 * getUserInfo(LoginBuyer("username", "pw"))
	 * 
	 * Then to retrieve the data to populate the profile page user.getSomething();
	 */
	...
	public static void EditUserInfo(Integer Id, String FirstName, String LastName, String Username, String PW,
